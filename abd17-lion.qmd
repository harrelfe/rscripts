...
Write a function that will retrieve labels and units stored in our dataset's metadata and format them into an expression that allows `ggplot2` to use a different font for units, with units placed to the right of the variable label.  
...
Studentized residuals are normalized for the standard deviation of the estimated mean.
