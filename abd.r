# Function for dealing with data from The Analysis of Biological Data by Shitlock and Schluter

getabd <- function(name='', lowernames=FALSE) {
  # Usage: getabd() to list all available datasets
  #        getabd('short name') to fetch one dataset
...
|07-q-26|Dog food pâté |http://whitlockschluter.zoology.ubc.ca/wp-content/data/chapter07/chap07q26DogFoodPate.csv|
...
csv.get(url[i], lowernames=lowernames)
}
